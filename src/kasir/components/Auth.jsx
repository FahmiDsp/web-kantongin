...
export default function Auth({ authMode, setAuthMode, onAuthSuccess, showToast }) {
      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-gray-100 animate-in fade-in duration-300">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            ...
            {!isLogin && (
              <p className="text-[10px] text-gray-500 mt-1">*Hanya huruf kecil, angka, dan garis bawah (_), tanpa spasi.</p>
            )}
          </div>
          ...
          <div>
            ...
            {!isLogin && (
              <p className="text-[10px] text-gray-500 mt-1">*Minimal 6 karakter untuk keamanan.</p>
            )}
          </div>
